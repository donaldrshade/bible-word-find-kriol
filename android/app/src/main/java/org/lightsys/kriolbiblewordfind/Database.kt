...
class Database(context: Context) :
    ...
    private fun fillTables(db: SQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO $PUZZLE_TABLE_NAME ( $PUZZLE_COL_1, $PUZZLE_COL_2, $PUZZLE_COL_3,$PUZZLE_COL_4,$PUZZLE_COL_5,$PUZZLE_COL_6,$PUZZLE_COL_7,$PUZZLE_COL_8) VALUES(117,8 , 12,0,"+"\"kriol_mrk_6_30_44_\""+",42,3,8)")
